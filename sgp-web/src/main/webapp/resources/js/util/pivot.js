...
(function() {
  ...
  PivotData = (function() {
    function PivotData(input, opts) {
      ...
      this.colTitleAttrs=opts.colsTitle;
      this.rowTitleAttrs=opts.rowsTitle;
  ...
  pivotTableRenderer = function(pivotData, opts) {
    ...
    colTitleAttrs=pivotData.colTitleAttrs;
    rowTitleAttrs=pivotData.rowTitleAttrs
    ...
    for (j in colAttrs) {
      ...
      if (parseInt(j) === 0 && rowAttrs.length !== 0) {
        ...
        //titulo de filas
        th.textContent = rowTitleAttrs;
        tr.appendChild(th);
      }
      th = document.createElement("th");
      th.className = "pvtAxisLabel";
      th.textContent = colTitleAttrs;
      tr.appendChild(th);
      //here
...
//        th.setAttribute("rowspan", colAttrs.length + (rowAttrs.length === 0 ? 0 : 1));
    ...
    if (rowAttrs.length !== 0) {
      ...
      for (i in rowAttrs) {
        ...
        //para que no aparezca en la segunda fila
//        th.className = "pvtAxisLabel";
//        th.textContent = rowTitleAttrs;
//        tr.appendChild(th);
      }
