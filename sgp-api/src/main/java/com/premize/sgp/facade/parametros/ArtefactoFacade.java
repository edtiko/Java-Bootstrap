 ...
 * @project sgp-web
 * @class ArtefactoFacade
 * @since 21/01/2014
 */
public interface ArtefactoFacade extends EntityFacade<SgpArtefacto, Integer> {
	 ...
	 * @throws Exception
	 */
	List<ArtefactoDTO> obtenerArtefactoPorMapaPrueba(Integer idMapaPrueba) throws Exception;
	 ...
	 * @throws Exception
	 */
	ResultSet<MapaArtefactoDTO> getMapaArtefactos(PagingCriteria criteria) throws Exception;
	 ...
	 * @param integer
	 */
	void eliminarArtefacto(Integer integer) throws AppBaseException;
